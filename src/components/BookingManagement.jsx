...
const BookingManagement = () => {
    ...
    useEffect(() => {
        const fetchTotalBookingsCount = async () => {
            const response = await axiosInstance.get('/odata/booking/$count');
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            ...
            try {
                ...
                const response = await axiosInstance.get(
                    `/odata/booking?$top=${pageSize}&$skip=${skip}&$select=id,createdAt,lastModifiedAt,status,startTime,serviceDate,predictEndTime,totalAmount,customerSelectedId,artistStoreId`
                );
